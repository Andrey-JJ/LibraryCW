...
namespace LibraryCW.Controllers
{
    public class LibrariansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LastName,Name,MidName,Age,Gender")] Librarian librarian)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LastName,Name,MidName,Age,Gender")] Librarian librarian)
        {
            if (id != librarian.Id)
            {
                return NotFound();
